...
#add form frame
selector_frame = tk.LabelFrame(root, padx=20, pady=20, bd=0)
...
def startClick():
    root.destroy()
    env = gym.make('CustomCartPole-v0', render_mode="human", selected_colors=colors)
